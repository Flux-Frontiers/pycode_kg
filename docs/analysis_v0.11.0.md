...
> - **Generated:** 2026-04-03T15:04:53Z
...
**Generated:** 2026-04-03 15:04:53 UTC
...
| 13 | `metrics_to_dict()` | src/code_kg/snapshots.py | **5** |
| 14 | `_add_var_edge()` | src/code_kg/visitor.py | **5** |
| 15 | `metrics()` | src/code_kg/snapshots.py | **5** |
...
|--------|-----------|---------|----------|----------|----------|
| `src/code_kg/viz3d.py` | 7 | 3 | 0 | 0 | 0.00 |
...
| `src/code_kg/snapshots.py` | 4 | 4 | 5 | 0 | 0.00 |
...
| `metrics_to_dict()` | src/code_kg/snapshots.py | 5 | function |
...
|------|-------|---------|--------|
| 1 | 0.138762 | 27 | `src/code_kg/store.py` |
| 2 | 0.092567 | 48 | `src/code_kg/viz3d.py` |
| 3 | 0.088227 | 25 | `src/code_kg/module/base.py` |
| 4 | 0.072997 | 23 | `src/code_kg/snapshots.py` |
| 5 | 0.048322 | 26 | `src/code_kg/module/types.py` |
| 6 | 0.046326 | 23 | `src/code_kg/index.py` |
| 7 | 0.044708 | 37 | `src/code_kg/codekg_thorough_analysis.py` |
| 8 | 0.037362 | 14 | `src/code_kg/analysis/centrality.py` |
| 9 | 0.033898 | 8 | `src/code_kg/codekg.py` |
| 10 | 0.033133 | 20 | `src/code_kg/visitor.py` |
| 11 | 0.032250 | 17 | `src/code_kg/layout3d.py` |
| 12 | 0.031768 | 24 | `src/code_kg/mcp_server.py` |
| 13 | 0.031516 | 9 | `src/code_kg/graph.py` |
| 14 | 0.030298 | 16 | `src/code_kg/module/extractor.py` |
| 15 | 0.025950 | 18 | `src/code_kg/architecture.py` |
...
| `Snapshot` | src/code_kg/snapshots.py | 1 | 1 | 1 |
...
| `SnapshotManager` | src/code_kg/snapshots.py | 0 | 1 | 0 |
...
|------|-------|------|------|--------|
| 1 | 0.000609 | method | `GraphStore.con` | src/code_kg/store.py |
| 2 | 0.000552 | method | `KGModule.store` | src/code_kg/module/base.py |
| 3 | 0.000510 | method | `CodeGraph.extract` | src/code_kg/graph.py |
| 4 | 0.000454 | function | `_get_kg` | src/code_kg/mcp_server.py |
| 5 | 0.000364 | function | `_load_dir_list` | src/code_kg/config.py |
| 6 | 0.000318 | method | `CodeKGVisitor._get_node_id` | src/code_kg/visitor.py |
| 7 | 0.000318 | method | `CodeKGVisitor._add_edge` | src/code_kg/visitor.py |
| 8 | 0.000313 | function | `expr_to_name` | src/code_kg/codekg.py |
| 9 | 0.000309 | method | `SnippetPack.to_dict` | src/code_kg/module/types.py |
| 10 | 0.000287 | function | `_run_pipeline` | src/code_kg/cli/cmd_build_full.py |
| 11 | 0.000281 | function | `_format_table` | src/code_kg/cli/cmd_centrality.py |
| 12 | 0.000276 | function | `metrics_to_dict` | src/code_kg/snapshots.py |
| 13 | 0.000262 | function | `delta_to_dict` | src/code_kg/snapshots.py |
| 14 | 0.000260 | class | `SnapshotDelta` | src/code_kg/snapshots.py |
| 15 | 0.000259 | method | `CodeKGVisitor._add_var_edge` | src/code_kg/visitor.py |
| 16 | 0.000255 | function | `_load_store` | src/code_kg/app.py |
| 17 | 0.000249 | method | `GraphStore.close` | src/code_kg/store.py |
| 18 | 0.000249 | method | `SentenceTransformerEmbedder.embed_texts` | src/code_kg/index.py |
| 19 | 0.000249 | method | `CodeKGExtractor.node_kinds` | src/code_kg/module/extractor.py |
| 20 | 0.000249 | method | `KGModule.close` | src/code_kg/module/base.py |
...
| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.7534 | function | `_init_state` | src/code_kg/app.py |
| 2 | 0.7481 | function | `_load_kg` | src/code_kg/app.py |
...
| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.8269 | method | `KGModule.store` | src/code_kg/module/base.py |
| 2 | 0.7594 | function | `_load_store` | src/code_kg/app.py |
...
*Report generated by CodeKG Thorough Analysis Tool — analysis completed in 3.3s*
