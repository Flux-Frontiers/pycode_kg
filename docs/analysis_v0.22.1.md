...
> - **Generated:** 2026-08-15T00:58:47Z
> - **Version:** pycode-kg 0.22.1
> - **Commit:** a9aedf4 (main)
> - **Platform:** macOS 27.0 | arm64 (arm) | turing | Python 3.12.13
> - **Graph:** 6431 nodes · 6012 edges (393 meaningful)
...
**Generated:** 2026-08-15 00:58:47 UTC
...
| :--- | ---: | ---: | :--- |
| Docstring coverage | 40.0 | 40 | 92.9% documented (full marks at 90%) |
| Dead code | 25.0 | 25 | 0 candidates / 335 definitions scanned (0.0%; zero points at 5%) |
...
| :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| `src/pycode_kg/viz3d.py` | 7 | 3 | 0 | 1 | 0.00 | externally driven |
...
Definitions re-exported from an `__init__.py` or otherwise reachable as public entry points, ranked by fan-in.  Top 10 of 39 shown.
...
| :--- | ---: | ---: | :--- |
| `function` | 144 | 157 | [OK] 91.7% |
| `method` | 140 | 148 | [OK] 94.6% |
| `class` | 28 | 30 | [OK] 93.3% |
| `module` | 53 | 58 | [OK] 91.4% |
| **total** | **365** | **393** | **[OK] 92.9%** |
...
| ---: | ---: | ---: | :--- |
| 1 | 0.106941 | 52 | `src/pycode_kg/viz3d.py` |
| 2 | 0.100580 | 25 | `src/pycode_kg/snapshots.py` |
| 3 | 0.078578 | 46 | `src/pycode_kg/pycodekg_thorough_analysis.py` |
| 4 | 0.061733 | 26 | `src/pycode_kg/mcp_server.py` |
| 5 | 0.055739 | 14 | `src/pycode_kg/analysis/centrality.py` |
| 6 | 0.045759 | 9 | `src/pycode_kg/graph.py` |
| 7 | 0.042764 | 20 | `src/pycode_kg/visitor.py` |
| 8 | 0.042057 | 8 | `src/pycode_kg/pycodekg.py` |
| 9 | 0.037978 | 18 | `src/pycode_kg/architecture.py` |
| 10 | 0.032485 | 4 | `src/pycode_kg/graph_html.py` |
| 11 | 0.031332 | 3 | `src/pycode_kg/ranking/cli_rank.py` |
| 12 | 0.030044 | 14 | `src/pycode_kg/ranking/coderank.py` |
| 13 | 0.024556 | 9 | `src/pycode_kg/kg.py` |
| 14 | 0.022659 | 15 | `src/pycode_kg/app.py` |
| 15 | 0.022137 | 7 | `src/pycode_kg/module/extractor.py` |
...
- Good docstring coverage: 92.9% of functions/methods/classes/modules documented
...
| ---: | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 2026-08-15 00:36:48 | feat/analysis-orphan-accuracy | 0.22.0 | 6431 | 6012 | 92.9% | +0 | +0 | +0.0% |
| 5 | 2026-08-14 13:05:54 | feat/analysis-orphan-accuracy | 0.22.0 | 6431 | 6012 | 92.9% | +49 | +29 | +0.1% |
| 6 | 2026-08-14 12:40:33 | feat/analysis-orphan-accuracy | 0.22.0 | 6382 | 5983 | 92.8% | -47 | -35 | +0.2% |
| 7 | 2026-08-14 12:33:44 | feat/analysis-orphan-accuracy | 0.22.0 | 6429 | 6018 | 92.6% | +248 | +190 | +0.2% |
| 10 | 2026-08-13 22:43:29 | main | 0.22.0 | 6181 | 5828 | 92.4% | -40 | -30 | -0.2% |
...
| ---: | ---: | :--- | :--- | :--- |
| 1 | 0.000622 | function | `_get_kg()` | src/pycode_kg/mcp_server.py |
| 2 | 0.000561 | method | `CodeGraph.extract()` | src/pycode_kg/graph.py |
| 3 | 0.000463 | function | `_rewrap()` | src/pycode_kg/snapshots.py |
| 4 | 0.000400 | function | `_load_dir_list()` | src/pycode_kg/config.py |
| 5 | 0.000350 | method | `PyCodeKGVisitor._get_node_id()` | src/pycode_kg/visitor.py |
| 6 | 0.000350 | method | `PyCodeKGVisitor._add_edge()` | src/pycode_kg/visitor.py |
| 7 | 0.000344 | function | `expr_to_name()` | src/pycode_kg/pycodekg.py |
| 8 | 0.000316 | function | `_run_pipeline()` | src/pycode_kg/cli/cmd_build_full.py |
| 9 | 0.000309 | function | `_format_table()` | src/pycode_kg/cli/cmd_centrality.py |
| 10 | 0.000285 | method | `PyCodeKGVisitor._add_var_edge()` | src/pycode_kg/visitor.py |
| 11 | 0.000280 | function | `_load_store()` | src/pycode_kg/app.py |
| 12 | 0.000271 | function | `load_snapshots_timeline()` | src/pycode_kg/viz3d_timeline.py |
| 13 | 0.000253 | method | `PyCodeKGVisitor._extract_reads()` | src/pycode_kg/visitor.py |
| 14 | 0.000249 | function | `delta_to_dict()` | src/pycode_kg/snapshots.py |
| 15 | 0.000249 | function | `delta_from_dict()` | src/pycode_kg/snapshots.py |
| 16 | 0.000247 | function | `_remove_highlight_actors()` | src/pycode_kg/viz3d.py |
| 17 | 0.000244 | method | `KGVisualizer._load_scores()` | src/pycode_kg/viz3d.py |
| 18 | 0.000244 | function | `metrics_to_dict()` | src/pycode_kg/snapshots.py |
| 19 | 0.000243 | method | `CodeGraph.nodes()` | src/pycode_kg/graph.py |
| 20 | 0.000243 | method | `CodeGraph.edges()` | src/pycode_kg/graph.py |
...
| Rank | Score | Kind | Name | Module |
| ---: | ---: | :--- | :--- | :--- |
| 1 | 0.7531 | function | `_load_kg()` | src/pycode_kg/app.py |
...
| Rank | Score | Kind | Name | Module |
| ---: | ---: | :--- | :--- | :--- |
| 1 | 0.7775 | function | `_load_store()` | src/pycode_kg/app.py |
| 2 | 0.7325 | function | `_get_store()` | src/pycode_kg/app.py |
...
| 5 | 0.7262 | function | `_load_kg()` | src/pycode_kg/app.py |
...
| Rank | Score | Kind | Name | Module |
| ---: | ---: | :--- | :--- | :--- |
| 1 | 0.7846 | method | `PyCodeKGVisitor._add_edge()` | src/pycode_kg/visitor.py |
| 2 | 0.7581 | method | `CodeGraph.edges()` | src/pycode_kg/graph.py |
| 3 | 0.7544 | function | `induce_query_subgraph()` | src/pycode_kg/ranking/coderank.py |
| 4 | 0.75 | function | `query_codebase()` | src/pycode_kg/mcp_server.py |
| 5 | 0.7483 | function | `compute_seed_proximity()` | src/pycode_kg/ranking/coderank.py |
