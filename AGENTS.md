...
This project uses [Codex Copilot](https://github.com/Everyone-Needs-A-Copilot/Codex-copilot).

**Full documentation:** `~/.Codex/copilot/README.md`
...
| `/setup-project` | Initialize Codex Copilot in a new project |
...
### No Time Estimates
All plans, roadmaps, and task breakdowns MUST omit time estimates. Use phases, priorities, complexity ratings, and dependencies instead of dates or durations. See `~/.Codex/copilot/AGENTS.md` for full policy.
