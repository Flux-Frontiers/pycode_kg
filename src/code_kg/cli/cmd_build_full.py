...
Click subcommand for building the full CodeKG pipeline in one step:
...
from code_kg.cli.options import (
    exclude_option,
    include_option,
    model_option,
    repo_option,
...
def _common_options(fn):
    ...
    fn = click.option(
        ...
        type=click.Path(),
        show_default=False,
        help="LanceDB directory path (default: <repo>/.codekg/lancedb).",
    )(fn)
    fn = click.option(
        "--table",
