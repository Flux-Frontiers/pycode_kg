...
Click subcommands for building the CodeKG knowledge graph:
...
from code_kg.cli.options import exclude_option, include_option, repo_option
...
def build_lancedb(
    ...
    """Build a LanceDB semantic index from an existing codekg SQLite database."""
    repo_root = Path(repo).resolve()
