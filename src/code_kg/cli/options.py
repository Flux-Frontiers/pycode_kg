"""
Shared Click option decorators for CodeKG CLI commands.
...
include_option = click.option(
    ...
    "Also reads [tool.codekg].include from pyproject.toml.",
)
...
exclude_option = click.option(
    ...
    "Also reads [tool.codekg].exclude from pyproject.toml.",
)
