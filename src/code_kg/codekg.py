#!/usr/bin/env python3
"""
Code Knowledge Graph (CodeKG) Extractor
...
- PASS 3: Data-flow edges (reads, writes, attribute access) via CodeKGVisitor
...
from code_kg.utils import node_id, rel_module_path
...
#: environment variable, e.g. ``export CODEKG_MODEL=BAAI/bge-small-en-v1.5``.
DEFAULT_MODEL: str = os.environ.get("CODEKG_MODEL", "BAAI/bge-small-en-v1.5")
