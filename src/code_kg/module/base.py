...
Provides the full CodeKG-equivalent infrastructure:
...
from code_kg.module.extractor import EdgeSpec, KGExtractor, NodeSpec
...
def _nodespec_to_node(spec: NodeSpec) -> Node:
    ...
    """
    from code_kg.codekg import Node  # pylint: disable=import-outside-toplevel
...
def _edgespec_to_edge(spec: EdgeSpec) -> Edge:
    ...
    """
    from code_kg.codekg import Edge  # pylint: disable=import-outside-toplevel
...
class KGModule(ABC):
    ...
    def make_extractor(self) -> KGExtractor:
        ...
        :return: A :class:`~code_kg.module.extractor.KGExtractor` instance.
        """
    ...
    def build(self, *, wipe: bool = False) -> BuildStats:
        ...
        :return: :class:`~code_kg.module.types.BuildStats`.
        """
    ...
    def build_graph(self, *, wipe: bool = False) -> BuildStats:
        ...
        of :class:`~code_kg.module.extractor.NodeSpec` and
        :class:`~code_kg.module.extractor.EdgeSpec`, converts them to the
        v0 :class:`~code_kg.codekg.Node` / :class:`~code_kg.codekg.Edge`
    ...
    def build_index(self, *, wipe: bool = False) -> BuildStats:
        ...
        :return: :class:`~code_kg.module.types.BuildStats` with
    ...
    def query(
        ...
        *,
        ...
        :return: :class:`~code_kg.module.types.QueryResult`.
        """
    ...
    def pack(
        ...
        *,
        ...
        :return: :class:`~code_kg.module.types.SnippetPack`.
        """
        q_norm = normalize_query_text(q)
        hits = self.index.search(q_norm, k=k)
        if min_score > 0.0:
    ...
    def stats(self) -> dict:
        ...
        :return: Dictionary from :meth:`~code_kg.store.GraphStore.stats`.
        """
