"""
viz3d_timeline.py — Temporal Metrics Visualization for CodeKG Snapshots
...
def load_snapshots_timeline(snapshots_dir: Path) -> dict[str, Any]:
    ...
    :param snapshots_dir: Path to .codekg/snapshots/
...
def create_timeline_figure(snapshots_dir: Path) -> go.Figure:
    ...
    # Update layout
    fig.update_layout(
        title_text="<b>CodeKG Temporal Metrics Evolution</b><br><sub>Snapshots across commits</sub>",
        title_font_size=20,
        height=800,
        width=1400,
        hovermode="x unified",
...
def create_3d_timeline_figure(snapshots_dir: Path) -> go.Figure:
    ...
    fig.update_layout(
        title="<b>CodeKG 3D Temporal Metrics</b><br><sub>Evolution across commits</sub>",
        scene=dict(
...
def display_timeline_summary(snapshots_dir: Path) -> str:
    ...
    summary = f"""
+================================================================+
|         CodeKG Temporal Metrics Summary                        |
+================================================================+
