...
| `src/pycode_kg/snapshots.py` | 1 | 5 | 5 | 0 | 0.00 |
...
|------|-------|---------|--------|
| 1 | 0.140038 | 27 | `src/pycode_kg/store.py` |
| 2 | 0.094064 | 26 | `src/pycode_kg/snapshots.py` |
| 3 | 0.090000 | 25 | `src/pycode_kg/module/base.py` |
| 4 | 0.082260 | 40 | `src/pycode_kg/viz3d.py` |
| 5 | 0.049234 | 26 | `src/pycode_kg/module/types.py` |
| 6 | 0.044950 | 37 | `src/pycode_kg/pycodekg_thorough_analysis.py` |
| 7 | 0.044566 | 23 | `src/pycode_kg/index.py` |
| 8 | 0.037184 | 14 | `src/pycode_kg/analysis/centrality.py` |
| 9 | 0.033566 | 8 | `src/pycode_kg/pycodekg.py` |
| 10 | 0.033165 | 20 | `src/pycode_kg/visitor.py` |
| 11 | 0.032267 | 17 | `src/pycode_kg/layout3d.py` |
| 12 | 0.031871 | 24 | `src/pycode_kg/mcp_server.py` |
| 13 | 0.030435 | 9 | `src/pycode_kg/graph.py` |
| 14 | 0.029778 | 16 | `src/pycode_kg/module/extractor.py` |
| 15 | 0.026032 | 18 | `src/pycode_kg/architecture.py` |
...
|------|-------|------|------|--------|
| 1 | 0.000617 | method | `GraphStore.con` | src/pycode_kg/store.py |
| 2 | 0.000559 | method | `KGModule.store` | src/pycode_kg/module/base.py |
| 3 | 0.000517 | method | `CodeGraph.extract` | src/pycode_kg/graph.py |
| 4 | 0.000460 | function | `_get_kg` | src/pycode_kg/mcp_server.py |
| 5 | 0.000369 | function | `_load_dir_list` | src/pycode_kg/config.py |
| 6 | 0.000322 | method | `PyCodeKGVisitor._get_node_id` | src/pycode_kg/visitor.py |
| 7 | 0.000322 | method | `PyCodeKGVisitor._add_edge` | src/pycode_kg/visitor.py |
| 8 | 0.000317 | function | `expr_to_name` | src/pycode_kg/pycodekg.py |
| 9 | 0.000313 | method | `SnippetPack.to_dict` | src/pycode_kg/module/types.py |
| 10 | 0.000313 | class | `SnapshotDelta` | src/pycode_kg/snapshots.py |
| 11 | 0.000309 | class | `SnapshotManifest` | src/pycode_kg/snapshots.py |
| 12 | 0.000304 | method | `SnapshotManager.load_manifest` | src/pycode_kg/snapshots.py |
| 13 | 0.000285 | function | `_format_table` | src/pycode_kg/cli/cmd_centrality.py |
...
| 16 | 0.000253 | method | `GraphStore.close` | src/pycode_kg/store.py |
| 17 | 0.000253 | method | `SentenceTransformerEmbedder.embed_texts` | src/pycode_kg/index.py |
| 18 | 0.000253 | method | `PyCodeKGExtractor.node_kinds` | src/pycode_kg/module/extractor.py |
| 19 | 0.000253 | method | `KGModule.close` | src/pycode_kg/module/base.py |
...
| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.824 | method | `KGModule.store` | src/pycode_kg/module/base.py |
...
*Report generated by PyCodeKG Thorough Analysis Tool — analysis completed in 1.1m*
