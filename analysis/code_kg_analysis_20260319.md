...
> - **Generated:** 2026-03-19T01:52:41Z
> - **Version:** code-kg 0.9.2
> - **Commit:** b648e76 (fix/snapshots)
> - **Platform:** macOS 26.3.1 | arm64 (arm) | Turing | Python 3.12.13
> - **Graph:** 6975 nodes · 6937 edges (459 meaningful)
...
**Generated:** 2026-03-19 01:52:41 UTC
...
| 2 | `close()` | src/code_kg/module/base.py | **15** |
| 3 | `close()` | src/code_kg/store.py | **15** |
| 4 | `node()` | src/code_kg/store.py | **14** |
| 5 | `con()` | src/code_kg/store.py | **12** |
| 6 | `store()` | src/code_kg/module/base.py | **8** |
| 7 | `compute_coderank()` | src/code_kg/ranking/coderank.py | **7** |
| 8 | `to_json()` | src/code_kg/module/types.py | **6** |
| 9 | `to_markdown()` | src/code_kg/module/types.py | **6** |
| 10 | `extract()` | src/code_kg/graph.py | **5** |
| 11 | `_add_edge()` | src/code_kg/visitor.py | **5** |
| 12 | `_get_node_id()` | src/code_kg/visitor.py | **5** |
| 13 | `to_dict()` | src/code_kg/module/types.py | **5** |
| 14 | `load_manifest()` | src/code_kg/snapshots.py | **5** |
| 15 | `_add_var_edge()` | src/code_kg/visitor.py | **5** |
...
| `src/code_kg/store.py` | 3 | 2 | 9 | 2 | 0.17 |
| `src/code_kg/module/types.py` | 11 | 4 | 4 | 0 | 0.00 |
| `src/code_kg/snapshots.py` | 1 | 5 | 5 | 0 | 0.00 |
| `src/code_kg/module/base.py` | 3 | 1 | 3 | 4 | 0.50 |
...
| `CodeGraph()` | src/code_kg/graph.py | 4 | class |
...
|------|-----------|-------|----------|
| `function` | 129 | 149 | [OK] 86.6% |
| `method` | 203 | 208 | [OK] 97.6% |
| `class` | 45 | 47 | [OK] 95.7% |
| `module` | 50 | 55 | [OK] 90.9% |
| **total** | **427** | **459** | **[OK] 93.0%** |
...
|------|-------|---------|--------|
| 1 | 0.140038 | 27 | `src/code_kg/store.py` |
| 2 | 0.094064 | 26 | `src/code_kg/snapshots.py` |
| 3 | 0.090000 | 25 | `src/code_kg/module/base.py` |
| 4 | 0.082260 | 40 | `src/code_kg/viz3d.py` |
| 5 | 0.049234 | 26 | `src/code_kg/module/types.py` |
| 6 | 0.044950 | 37 | `src/code_kg/codekg_thorough_analysis.py` |
| 7 | 0.044566 | 23 | `src/code_kg/index.py` |
| 8 | 0.037184 | 14 | `src/code_kg/analysis/centrality.py` |
| 9 | 0.033566 | 8 | `src/code_kg/codekg.py` |
| 10 | 0.033165 | 20 | `src/code_kg/visitor.py` |
| 11 | 0.032267 | 17 | `src/code_kg/layout3d.py` |
| 12 | 0.031871 | 24 | `src/code_kg/mcp_server.py` |
| 13 | 0.030435 | 9 | `src/code_kg/graph.py` |
| 14 | 0.029778 | 16 | `src/code_kg/module/extractor.py` |
| 15 | 0.026032 | 18 | `src/code_kg/architecture.py` |
...
| `CodeKG` | src/code_kg/kg.py | 1 | 1 | 0 |
| `AlliumLayout` | src/code_kg/layout3d.py | 1 | 1 | 0 |
| `LayerCakeLayout` | src/code_kg/layout3d.py | 1 | 1 | 0 |
| `CodeKGExtractor` | src/code_kg/module/extractor.py | 1 | 1 | 0 |
| `Embedder` | src/code_kg/index.py | 0 | 0 | 1 |
| `Layout3D` | src/code_kg/layout3d.py | 0 | 1 | 2 |
| `KGModule` | src/code_kg/module/base.py | 0 | 1 | 1 |
| `KGExtractor` | src/code_kg/module/extractor.py | 0 | 1 | 1 |
...
|---|-----------|--------|---------|-------|-------|----------|---------|---------|------------|
| 1 | 2026-03-19 01:26:59 | fix/snapshots | 0.9.2 | 6975 | 6937 | 93.0% | -13 | -14 | +0.0% |
| 2 | 2026-03-19 01:15:26 | fix/snapshots | 0.9.1 | 6988 | 6951 | 93.0% | +47 | +29 | +0.0% |
| 3 | 2026-03-16 22:01:14 | main | 0.9.0 | 6941 | 6922 | 93.0% | +0 | +0 | +0.0% |
| 4 | 2026-03-15 03:59:18 | feature/kg-factory | 0.9.0 | 6941 | 6922 | 93.0% | +160 | +359 | +0.3% |
| 5 | 2026-03-14 23:58:50 | main | 0.81b | 6781 | 6563 | 92.7% | -1 | -2 | +0.0% |
| 6 | 2026-03-14 21:46:51 | develop | 0.8.1 | 6782 | 6565 | 92.7% | +0 | +0 | +0.0% |
| 7 | 2026-03-14 21:15:43 | refactor/cleanup-output | 0.8.1 | 6782 | 6565 | 92.7% | +0 | +0 | +0.0% |
| 8 | 2026-03-14 18:14:58 | main | 0.8.1 | 6782 | 6565 | 92.7% | +0 | +0 | +0.0% |
| 9 | 2026-03-14 18:04:40 | main | 0.8.1 | 6782 | 6565 | 92.7% | +0 | +0 | +0.0% |
| 10 | 2026-03-14 17:54:01 | main | 0.8.1 | 6782 | 6565 | 92.7% | +41 | +30 | +0.0% |
...
|----------|--------|-------|
| `_analyze_dependencies()` | src/code_kg/codekg_thorough_analysis.py | 61 |
---
...
|------|-------|------|------|--------|
| 1 | 0.000617 | method | `GraphStore.con` | src/code_kg/store.py |
| 2 | 0.000559 | method | `KGModule.store` | src/code_kg/module/base.py |
| 3 | 0.000517 | method | `CodeGraph.extract` | src/code_kg/graph.py |
| 4 | 0.000460 | function | `_get_kg` | src/code_kg/mcp_server.py |
| 5 | 0.000369 | function | `_load_dir_list` | src/code_kg/config.py |
| 6 | 0.000322 | method | `CodeKGVisitor._get_node_id` | src/code_kg/visitor.py |
| 7 | 0.000322 | method | `CodeKGVisitor._add_edge` | src/code_kg/visitor.py |
| 8 | 0.000317 | function | `expr_to_name` | src/code_kg/codekg.py |
| 9 | 0.000313 | method | `SnippetPack.to_dict` | src/code_kg/module/types.py |
| 10 | 0.000313 | class | `SnapshotDelta` | src/code_kg/snapshots.py |
| 11 | 0.000309 | class | `SnapshotManifest` | src/code_kg/snapshots.py |
| 12 | 0.000304 | method | `SnapshotManager.load_manifest` | src/code_kg/snapshots.py |
| 13 | 0.000285 | function | `_format_table` | src/code_kg/cli/cmd_centrality.py |
| 14 | 0.000262 | method | `CodeKGVisitor._add_var_edge` | src/code_kg/visitor.py |
| 15 | 0.000259 | function | `_load_store` | src/code_kg/app.py |
| 16 | 0.000253 | method | `GraphStore.close` | src/code_kg/store.py |
| 17 | 0.000253 | method | `SentenceTransformerEmbedder.embed_texts` | src/code_kg/index.py |
| 18 | 0.000253 | method | `CodeKGExtractor.node_kinds` | src/code_kg/module/extractor.py |
| 19 | 0.000253 | method | `KGModule.close` | src/code_kg/module/base.py |
| 20 | 0.000250 | function | `load_snapshots_timeline` | src/code_kg/viz3d_timeline.py |
...
| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.7533 | function | `_init_state` | src/code_kg/app.py |
| 2 | 0.748 | function | `_load_kg` | src/code_kg/app.py |
| 3 | 0.7414 | function | `main` | src/code_kg/mcp_server.py |
| 4 | 0.7405 | method | `CodeKGExtractor.__init__` | src/code_kg/module/extractor.py |
| 5 | 0.7305 | method | `KGExtractor.__init__` | src/code_kg/module/extractor.py |

### Data Persistence Storage Database

| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.824 | method | `KGModule.store` | src/code_kg/module/base.py |
| 2 | 0.7586 | function | `_load_store` | src/code_kg/app.py |
| 3 | 0.7197 | method | `SemanticIndex.build` | src/code_kg/index.py |
| 4 | 0.7104 | function | `_get_store` | src/code_kg/app.py |
| 5 | 0.7077 | method | `GraphStore.__init__` | src/code_kg/store.py |

### Query Search Retrieval Semantic

| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.75 | method | `SemanticIndex.search` | src/code_kg/index.py |
| 2 | 0.7323 | method | `KGModule.query` | src/code_kg/module/base.py |
| 3 | 0.7203 | function | `query_codebase` | src/code_kg/mcp_server.py |
| 4 | 0.7094 | function | `query` | src/code_kg/cli/cmd_query.py |
| 5 | 0.7079 | function | `query_ranked` | src/code_kg/mcp_server.py |
...
*Report generated by CodeKG Thorough Analysis Tool — analysis completed in 1.1m*
