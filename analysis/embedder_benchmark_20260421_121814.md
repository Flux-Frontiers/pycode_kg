...
- Started (UTC): 2026-04-21T12:18:14.568404+00:00
- Completed (UTC): 2026-04-21T12:18:56.703881+00:00
...
- Build: 41.91s, indexed_rows=476, dim=768
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `hybrid` | 0.146 | 8 | 49 | 10 | 0.922 | 0.619 | 0.533 |
| `semantic` | 0.012 | 8 | 49 | 10 | 1.000 | 0.634 | 0.333 |
...
| Mode | Time (s) | Seeds | Expanded | Returned | Mean score | Mean semantic | Mean lexical |
|---|---:|---:|---:|---:|---:|---:|---:|
| `hybrid` | 0.038 | 6 | 6 | 6 | 0.989 | 0.493 | 0.000 |
| `semantic` | 0.011 | 6 | 6 | 6 | 0.989 | 0.493 | 0.000 |
...
| Mode | Time (s) | Seeds | Expanded | Returned | Mean score | Mean semantic | Mean lexical |
|---|---:|---:|---:|---:|---:|---:|---:|
| `hybrid` | 0.011 | 8 | 63 | 8 | 0.964 | 0.599 | 0.378 |
| `semantic` | 0.009 | 8 | 63 | 8 | 1.000 | 0.601 | 0.156 |
...
- 5. `CodeGraph` (score=0.940, sem=0.599, lex=0.333, hop=1)
