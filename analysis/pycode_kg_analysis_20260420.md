...
> - **Generated:** 2026-04-20T23:33:10Z
> - **Version:** pycode-kg 0.14.1
> - **Commit:** 43070c5 (development)
> - **Platform:** macOS 26.4.1 | arm64 (arm) | Turing | Python 3.12.13
> - **Graph:** 7187 nodes · 7144 edges (474 meaningful)
...
**Generated:** 2026-04-20 23:33:10 UTC
...
|------|-----------|-------|----------|
| `function` | 140 | 157 | [OK] 89.2% |
| `method` | 204 | 215 | [OK] 94.9% |
| `class` | 44 | 46 | [OK] 95.7% |
| `module` | 51 | 56 | [OK] 91.1% |
| **total** | **439** | **474** | **[OK] 92.6%** |
...
|------|-------|---------|--------|
| 1 | 0.139084 | 27 | `src/pycode_kg/store.py` |
| 2 | 0.090684 | 48 | `src/pycode_kg/viz3d.py` |
| 3 | 0.087036 | 25 | `src/pycode_kg/module/base.py` |
| 4 | 0.078951 | 25 | `src/pycode_kg/snapshots.py` |
| 5 | 0.047736 | 26 | `src/pycode_kg/module/types.py` |
| 6 | 0.045811 | 23 | `src/pycode_kg/index.py` |
| 7 | 0.043982 | 37 | `src/pycode_kg/pycodekg_thorough_analysis.py` |
| 8 | 0.036641 | 14 | `src/pycode_kg/analysis/centrality.py` |
| 9 | 0.033345 | 8 | `src/pycode_kg/pycodekg.py` |
| 10 | 0.032486 | 20 | `src/pycode_kg/visitor.py` |
| 11 | 0.031594 | 17 | `src/pycode_kg/layout3d.py` |
| 12 | 0.031161 | 9 | `src/pycode_kg/graph.py` |
| 13 | 0.031125 | 24 | `src/pycode_kg/mcp_server.py` |
| 14 | 0.029717 | 16 | `src/pycode_kg/module/extractor.py` |
| 15 | 0.025419 | 18 | `src/pycode_kg/architecture.py` |
...
1. **Version and stabilize the public API** — document breaking-change policies for `GraphStore`, `SnapshotManager`, `PyCodeKG`
...
|---|-----------|--------|---------|-------|-------|----------|---------|---------|------------|
| 1 | 2026-04-20 23:17:26 | main | 0.14.1 | 7187 | 7144 | 92.6% | +0 | +0 | +0.0% |
| 2 | 2026-04-20 17:27:44 | main | 0.14.0 | 7187 | 7144 | 92.6% | +9 | +5 | +0.0% |
| 3 | 2026-04-13 02:48:59 | main | 0.12.0 | 7178 | 7139 | 92.6% | +0 | +1 | +0.0% |
| 4 | 2026-04-13 02:41:47 | main | 0.12.0 | 7178 | 7138 | 92.6% | -2 | -3 | +0.0% |
| 5 | 2026-04-13 02:34:25 | main | 0.12.0 | 7180 | 7141 | 92.6% | +111 | +131 | +0.1% |
| 6 | 2026-04-07 17:43:34 | main | 0.12.0 | 7069 | 7010 | 92.5% | +23 | +23 | +0.0% |
| 7 | 2026-04-07 13:25:43 | main | 0.11.0 | 7046 | 6987 | 92.5% | -12 | -12 | -0.2% |
| 8 | 2026-04-06 13:21:44 | main | 0.11.0 | 7058 | 6999 | 92.7% | +0 | +0 | +0.0% |
| 9 | 2026-03-22 16:55:23 | main | 0.9.3 | 7058 | 6999 | 92.7% | +24 | +13 | +0.0% |
| 10 | 2026-03-20 02:42:41 | main | 0.9.3 | 7034 | 6986 | 92.7% | -12 | -8 | +0.7% |
...
|------|-------|------|------|--------|
| 1 | 0.000598 | method | `GraphStore.con` | src/pycode_kg/store.py |
| 2 | 0.000542 | method | `KGModule.store` | src/pycode_kg/module/base.py |
| 3 | 0.000501 | method | `CodeGraph.extract` | src/pycode_kg/graph.py |
| 4 | 0.000445 | function | `_get_kg` | src/pycode_kg/mcp_server.py |
| 5 | 0.000357 | function | `_load_dir_list` | src/pycode_kg/config.py |
| 6 | 0.000350 | function | `metrics_to_dict` | src/pycode_kg/snapshots.py |
...
| 12 | 0.000282 | function | `_run_pipeline` | src/pycode_kg/cli/cmd_build_full.py |
...
| 18 | 0.000249 | class | `SnapshotMetrics` | src/pycode_kg/snapshots.py |
...
| 3 | 0.7436 | method | `PyCodeKGExtractor.__init__` | src/pycode_kg/module/extractor.py |
| 4 | 0.7435 | function | `main` | src/pycode_kg/mcp_server.py |
